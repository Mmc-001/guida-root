...
\lstset{
    ...
    columns=fixed,    % ensures fixed spacing (avoids extra invisible characters)
    upquote=true      % ensures that quotes are rendered as plain text
}
